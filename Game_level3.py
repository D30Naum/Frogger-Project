...
# Devi Naum
# Blake Kell
""" This file contains the necessary pygame code to run the third level of difficulty for the game."""
...
def gameStart2():
    ...
    pygame.time.set_timer(ADDENEMY, 600)  # Creates the event needed for us to add the multiple enemies popping up.
    ...
    # pygame.mixer.music.load("Lofi_why.mp3")
