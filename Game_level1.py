...
# Devi Naum
# Blake Kell
""" This file contains the necessary pygame code to run the first level of difficulty for the game."""
# import all the necessary modules, especially pygame and all the buttons needed to play from pygame.locals
from Game_level2 import *
import pygame
import random
...
def gameStart():
    ...
    pygame.time.set_timer(ADDENEMY, 1000)  # Creates the event needed for us to add the multiple enemies popping up.
    ...
    # pygame.mixer.music.load("Lofi_music.mp3")
    ...
    while running:
        ...
        for entity in all_sprites:
            """ Updates the screen with the character and the enemies."""
